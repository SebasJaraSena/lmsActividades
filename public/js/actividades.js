      ...
      buttons: [
        //  Boton para exportar archivos en formato Excel
        {
          ...
          customize: function (xlsx) {
            ...
            var row = '<row r="1"><c t="inlineStr" r="A1"><is><t>' + formattedDate + ' ' + additionalData + "</t></is></c></row>";
            ...
            sheet.childNodes[0].childNodes[1].innerHTML = row + sheet.childNodes[0].childNodes[1].innerHTML;
