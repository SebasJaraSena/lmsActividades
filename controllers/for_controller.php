...
try {
    // LLAMADA A LA FUNCION PARA OBTENER LOS FOROS REALIZADAS EN ZAJUNA
    $titulos = $conn->prepare("SELECT obtenerForos(:curso)");
    $titulos->bindParam(':curso', $id_curso, PDO::PARAM_STR);
    $titulos->execute();
    $acti_query = "SELECT * FROM vista_foros ORDER BY itemname ASC";
