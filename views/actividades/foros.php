...
?>
    <main>
        ...
        <div class="container-fluid px-4">
            ...
            <h3 style="text-align: center;"><img class="ml-2" src="../../public/assets/img/documento.svg" alt="icono">FOROS
            </h3>
                                    ...
                                    <thead>
                                        <tr id="actividades-thead">
                                            ...
                                            foreach ($actividades as $actividad) {
                                                ...
                                                echo
                                                '<th>
                                                <div class="text-justify">' . $name_for . '</div>
                                            </th>';
                                            }
                                            ?>
                                        </tr>
                                    ...
                                    foreach ($userApr as $user) {
                                        ...
                                        foreach ($q_grades as $q_grade) {
                                            ...
                                            if (!empty($grad)) {
                                                ...
                                                $id_for = $actividad->idacti;
                                                // LLAMADA A LA FUNCION PARA OBTENER LOS PARAMETROS DE REDIRECCIÓN DE ACTIVIDADES PENDIENTES POR EL APRENDIZ
                                                $params = obtenerParametros($conn, $id_for);
                                                foreach ($params as $param) {
                                                    $id = $param['id'];
                                                }
