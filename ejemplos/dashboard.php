                ...
                <div class="m col rounded" style=" box-shadow: 0px 0px 30px gray; padding: 2em;">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <script>
                                function redirectToActividad(curso, categoria) {
                                    window.location.href = `actividades.php?id_curso=${curso}&categoria=${categoria}`;
                                }
                            </script>
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            function redirectToEvidencias(id_curso) {
                                window.location.href = `evidencias.php?id_curso=${id_curso}`;
                            }
                        </script>
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            function redirectToForos(id_curso) {
                                window.location.href = `foros.php?id_curso=${id_curso}`;
                            }
                        </script>
